  ...
  <ul>
	...
	<nav style="background-color: #592EFC; z-index: 9999;">
		<ul class="main-menu" style="background-color: #592EFC">
			...
			<li><a href="#">커뮤니티</a>
				<ul class="sub-menu">
					<li><a href='<c:url value="/freedom/main.do" />' aria-label="submenu">자유게시판</a></li>
					<li><a href='<c:url value="/reference/list.do" />' aria-label="submenu">자료실</a></li>
					<li><a href="${pageContext.request.contextPath}/review/list.do" aria-label="submenu">수강후기</a></li>
				</ul>
			</li>
			...
			<li><a href="#">고객센터</a>
				<ul class="sub-menu">
					...
					<li><a href='<c:url value="/q_bbs/list.do" />' aria-label="submenu">질문과 답변</a></li>
				</ul>
			</li>
