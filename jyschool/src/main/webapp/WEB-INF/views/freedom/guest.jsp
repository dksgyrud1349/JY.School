...
function sendGuest() {
	...
	f.action = "${pageContext.request.contextPath}/freedom/write_ok.do";
	f.submit();
}

function deleteGuest(num) {
	let url = "${pageContext.request.contextPath}/freedom/delete.do?num=" + num + "&page=${page}";
...
<main>
	<div class="container body-container">
	    <div class="body-title">
			<h2><i class="far fa-edit"></i> 자유게시판 </h2>
	    </div>
			...
			<form name="guestForm" method="post">
				<div class="guest-form">
					<div class="form-header">
						<span class="bold">글 쓰기</span><span> - 타인을 비방하거나 개인정보를 유출하는 글은 삭제 됩니다.</span>
					</div>
					<div class="form-body">
								...
								<div class="item-header">
									...
									<div class="item-header-right">
										...
										<c:if test="${sessionScope.member.userId==dto.userId || sessionScope.member.userId=='admin'}">
											|<span class="item-delete" onclick="deleteGuest('${dto.num}');">삭제</span>
										</c:if> 
									</div>
								</div>
